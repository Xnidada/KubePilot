...
| Pod 管理 | CRD 管理 | 资源监控 |
|:--------:|:--------:|:--------:|
| ![Pod](images/04pod.png) | ![CRD](images/05crd.png) | ![监控](images/06资源监控.png) |

| AI 助手 | AI Agent | 智能诊断 |
|:-------:|:--------:|:--------:|
| ![AI助手](images/07AI助手.png) | ![Agent](images/08AIAGENT.png) | ![诊断](images/09智能诊断.png) |

| 日志问诊 | 资源指南 | 用户权限 |
|:--------:|:--------:|:--------:|
| ![日志](images/10日志问诊.png) | ![指南](images/11资源指南.png) | ![权限](images/12用户权限管理.png) |
...
- 命名空间管理（创建、编辑标签、删除）
- YAML 在线编辑器（使用 client-go，无需 kubectl）
...
> **注意**：Job 的创建已整合到任务调度引擎中，支持优先级调度和队列管理。
...
POST   /api/v1/aiops/analyze-describe # Describe 解读
